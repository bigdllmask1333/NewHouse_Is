...
//
//
//                ['text', 'username', '登录名', '必填，可由英文字母、数字组成'],
//                ['password', 'password', '密码', '必填，6-20位'],
//                ['radio', 'sex', '用户性别', '', ['男', '女'], 0],
//                ['text', 'nickname', '用户姓名', '可以是中文'],
//                ['select', 'role', '角色', '', RoleModel::getTree(null, false)],
//                ['text', 'section', '部门', ''],
//                ['text', 'quarters', '岗位', ''],
//                ['text', 'mobile', '移动电话'],
//                ['text', 'fixed_phone', '固定电话'],
//                ['image', 'avatar', '头像'],
